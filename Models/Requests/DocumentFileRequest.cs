...
public sealed class TicketBaiIssuerInfo
{
    ...
    /// <para>Solo para personas físicas en régimen de estimación objetiva.</para>
    /// </summary>
...
public sealed class InvoiceLine
{
    ...
    /// <para>Opcional. Informar solo si hay descuento.</para>
    /// </summary>
    ...
    /// <para>Opcional. Solo para operaciones con recargo de equivalencia.</para>
    /// </summary>
    ...
    /// <para>Solo para líneas exentas o no sujetas.</para>
    /// </summary>
...
/// <summary>
/// Metadatos estadísticos para identificar la plataforma o usuario origen.
/// </summary>
public sealed class DocumentMetadata
{
    /// <summary>Versión de la plataforma origen. <para><b>Requerido.</b></para></summary>
    public string Version { get; set; } = string.Empty;

    /// <summary>Identificador del usuario origen. <para><b>Requerido.</b></para></summary>
    public string User { get; set; } = string.Empty;

    /// <summary>Email del usuario origen. <para><b>Requerido.</b></para></summary>
    public string Email { get; set; } = string.Empty;

    /// <summary>Nombre de la empresa origen. <para><b>Requerido.</b></para></summary>
    public string Company { get; set; } = string.Empty;

    /// <summary>Identificador del tenant origen. <para><b>Requerido.</b></para></summary>
    public string Tenant { get; set; } = string.Empty;

    /// <summary>Descripción libre. <para><b>Requerido.</b></para></summary>
    public string Description { get; set; } = string.Empty;

    /// <summary>Nombre de la plataforma origen (ej. "BusinessCentral", "Custom"). <para><b>Requerido.</b></para></summary>
...
public sealed class TicketBaiDocumentFile
{
    ...
    /// <para>No requerido para facturas simplificadas.</para>
    /// </summary>
    ...
    /// <para>No requerido para facturas simplificadas ni para destinatarios nacionales.</para>
    /// </summary>
