...
/// <summary>
/// Excepción base para errores de la API IQ eSign TicketBAI.
/// </summary>
...
/// <summary>
/// Excepción lanzada cuando falla la autenticación con la API IQ eSign TicketBAI.
...
/// <summary>
/// Excepción lanzada cuando la API IQ eSign TicketBAI devuelve un error HTTP no esperado (4xx/5xx).
/// </summary>
