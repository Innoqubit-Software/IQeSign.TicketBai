...
namespace IQeSign.TicketBai.Configuration;

/// <summary>
/// Opciones de configuración para el cliente IQ eSign TicketBAI.
/// </summary>
public sealed class IQeSignOptions
{
    ...
    /// </summary>
    public const string SectionName = "IQeSignTicketBai";
...
/// <summary>
/// Nombres de los clientes HTTP registrados para IQeSign TicketBAI.
/// </summary>
internal static class HttpClientNames
{
    internal const string Production = "IQeSign.TicketBai.Production";
    internal const string Staging = "IQeSign.TicketBai.Staging";
}
